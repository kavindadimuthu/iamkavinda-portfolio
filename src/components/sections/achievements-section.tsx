...
const achievements = [
  {
    ...
    description: "Recognition for Readlle - an inclusive, dyslexia-friendly learning platform that prioritizes accessibility in education.",
    icon: Trophy,
  ...
  },
  {
    ...
    description: "Active contributions to open-source projects, helping improve accessibility and user experience in web applications.",
    icon: Award,
    category: "Community",
    year: "Ongoing",
    impact: "Global Reach",
  ...
  },
  {
    ...
    description: "Specialized in creating inclusive, accessible web applications that serve users with diverse needs and abilities.",
    icon: Target,
    category: "Innovation",
    year: "2024-2025",
...
export function AchievementsSection() {
  ...
  return (
    <motion.section 
      ...
      transition={{ duration: 0.7, delay: 0.7, ease: [0.25, 0.46, 0.45, 0.94] as [number, number, number, number] }}
    >
      <div className="container mx-auto container-padding">
        ...
        <div className={`mb-12 reveal-up ${sectionVisible ? 'animate-in' : ''}`}
            ...
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left flex-1">
                  ...
                  <p className="text-xl text-white/90 mb-3">2nd Runner-up</p>
                  <p className="text-white/80 leading-relaxed">
                    National recognition for developing Readlle, an innovative accessibility-first 
                    learning platform that makes education more inclusive for students with dyslexia.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        >
          {achievements.slice(1).map((achievement, index) => (
            <motion.div
              ...
              transition={transitions.smooth}
            >
               <Card className={`hover-lift transition-smooth shadow-card border-2 ${achievement.bgColor} ${achievement.borderColor}`}>
              <CardContent className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div className={`p-3 rounded-xl ${achievement.bgColor} ${achievement.borderColor} border`}>
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`font-semibold text-sm ${achievement.color} mb-2`}>
        ...
        >
          {[
            ...
            <motion.div
              ...
              transition={transitions.smooth}
            >
               <Card className="text-center hover-scale transition-smooth shadow-card border-2 bg-gradient-card">
              <CardContent className="p-6">
